# IDLE SOCIAL: il tuo vecchio iPhone come telecomando AI per il Mac

> **Versione 1.** La versione 2, con più dispositivi sincronizzati, widget del Mac, azioni rapide e opzioni, è **IDLE SYNC** nella cartella [`../idle-sync`](../idle-sync).
...
4. Tocca **Condividi → Aggiungi alla schermata Home**. Da ora "IDLE SOCIAL" si apre a tutto schermo come un'app.
...
- **Accesso Guidato** (Impostazioni → Accessibilità → Accesso Guidato): blocca l'iPhone dentro IDLE SOCIAL, così diventa un telecomando e basta. Triplo clic sul tasto laterale per attivarlo.
